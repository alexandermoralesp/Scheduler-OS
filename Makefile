...
cfs: driver_cfs.o list.o CPU.o schedule_cfs.o
	$(CC) $(CFLAGS) -o cfs driver_cfs.o schedule_cfs.o list.o CPU.o
...
schedule_cfs.o: schedule_cfs.c
	$(CC) $(CFLAGS) -c schedule_cfs.c
...
driver_cfs.o: driver_cfs.c
	$(CC) $(CFLAGS) -c driver_cfs.c
